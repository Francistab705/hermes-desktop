...
> **Phase:** 6 (build LAST) · **Mechanism:** new screen/component module + **Neo4j infra**
...
> **Doc written now, BUILD deferred to Phase 6.** Every other feature is a plugin
